...
//  -*- C++ -*-.
#ifndef MYTRACKFASTSIMEVAL_H
#define MYTRACKFASTSIMEVAL_H
...
class MyTrackFastSimEval : public SubsysReco
{
 public:
  //Default constructor
  MyTrackFastSimEval(const std::string& name = "MyTrackFastSimEval",
  ...
  //Set the flag
  //Flags should be set like set_flag(MyTrackFastSimEval::TRUTH, true) from macro
