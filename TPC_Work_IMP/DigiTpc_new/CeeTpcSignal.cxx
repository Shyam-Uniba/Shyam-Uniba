...
CeeTpcSignal::CeeTpcSignal()
  : ft(0),famp(0),fpadId(0),fmcEventId(0),fSectorId(0),fRowId(0),
	fmcTrackId(0),fmcMotherId(0),fmcHitId(0),fmother(0), fEvent(0)
{;}
...
CeeTpcSignal::CeeTpcSignal(unsigned int event, double T,
  ...
  : fEvent(event), ft(T),famp(Amp),fpadId(PadID),fSectorId(SectorId),fRowId(RowId),fmother(Mother)
{
fmcTrackId = 0;
fmcMotherId = 0;
fmcHitId = 0;
