...
public:
  ...
  CeeTpcDigi();
  CeeTpcDigi(const unsigned int PadID, const unsigned int index = 0, const int sec = 0,
		     const int region = 0, const int timebin = 0, const int adc =0, const int mctrackId = 0);
