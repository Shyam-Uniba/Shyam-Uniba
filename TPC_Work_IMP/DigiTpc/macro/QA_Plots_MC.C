...
TH2D *hxymc= new TH2D("hxymc","MC Points",1000,-50,50,1200,-60,60);
TH2D *hxyhit= new TH2D("hxyhit","Hit Points",1000,-50,50,1200,-60,60);
...
c2->cd();
sim->Draw("CeeTpcPoint.fX:CeeTpcPoint.fZ>> hxymc","","");
sim1->Draw("CeeTpcHit.fX:CeeTpcHit.fZ>> hxyhit","","");
hxymc->SetMarkerStyle(31);
hxymc->SetMarkerColor(kBlue);
hxymc->GetXaxis()->SetTitle("Z [cm]");
hxymc->GetYaxis()->SetTitle("X [cm]");
