void Cee_TPC()
{
 ...
 TPaveText* pt[5];
   ...
   TH3F *h3box = new TH3F("h3box","Pad Size = 5 x 12 mm^{2}",75, -45.,45., 240, -60., 60., 80, -40., 40.);
   TH3F *h3box1 = new TH3F("h3box1","Pad Size = 5 x 12 mm^{2}",1, -45.,45., 1, -60., 60., 80, -40., 40.);
   TH3F *h3box2 = new TH3F("h3box2","Pad Size = 5 x 12 mm^{2}",75, -45.,45., 120, -60., 60., 80, -40., 40.);
   int count=0;

for (double z=-45; z<45; z=z+1.2){
for (double x = -60; x<60; x=x+0.5){
      count++;
      h3box->Fill(z+1.2/2, x+0.5/2,39.9,  1.);
