...
class DetectorK : public TNamed {
 ...
 protected:
  ...
  Double_t fTotalMomenta[kNptBins];                          // array of total momentum
  Double_t fMomentumRes[kNptBins];                           // array of transverse momentum resolution
  Double_t fTotalMomentumRes[kNptBins];                      // array of momentum resolutions
