...
float phispan = 360;//0
int phibins =  1;
//float thetamin =  -84.3; // theta = 0 is perpendicular to beam axis, was 
//float thetamin =  27.524; // theta = 0 is perpendicular to beam axis, was 
//float thetamin =  64.843; // theta = 0 is perpendicular to beam axis, was 
//float thetamin =  84.3; // theta = 0 is perpendicular to beam axis, was 
float thetamin =  -88; // theta = 0 is perpendicular to beam axis, was 
float thetaspan = 176; 
int thetabins = 1000;
