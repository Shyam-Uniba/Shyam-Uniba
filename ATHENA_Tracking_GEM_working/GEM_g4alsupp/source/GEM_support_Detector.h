...
class GEM_support_Detector : public PHG4Detector
{
	public:
		//! constructor
		GEM_support_Detector(PHG4Subsystem *subsys, PHCompositeNode *Node, PHParameters *parameters, const std::string &dnam);

		//! destructor
		virtual ~GEM_support_Detector() {}
