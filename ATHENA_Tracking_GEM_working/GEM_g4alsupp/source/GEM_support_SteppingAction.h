...
class GEM_support_SteppingAction : public PHG4SteppingAction
{
 public:
  //! constructor
  GEM_support_SteppingAction(GEM_support_Detector*, const PHParameters* parameters);

  //! destructor
  virtual ~GEM_support_SteppingAction();
