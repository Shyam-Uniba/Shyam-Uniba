...
//____________________________________________________________________________..
Al_support_SteppingAction::Al_support_SteppingAction(Al_support_Detector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
Al_support_SteppingAction::~Al_support_SteppingAction()
{
...
bool Al_support_SteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void Al_support_SteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "Al_support_SteppingAction::SetTopNode - unable to find "
