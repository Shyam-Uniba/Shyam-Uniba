#include "Al_support_DisplayAction.h"
...
Al_support_DisplayAction::Al_support_DisplayAction(const std::string &name)
  : PHG4DisplayAction(name)
  , m_MyVolume(nullptr)
{
}

Al_support_DisplayAction::~Al_support_DisplayAction()
{
...
void Al_support_DisplayAction::ApplyDisplayAction(G4VPhysicalVolume *physvol)
{
