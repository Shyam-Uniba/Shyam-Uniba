...
//____________________________________________________________________________..
GEM_support_SteppingAction::GEM_support_SteppingAction(GEM_support_Detector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
GEM_support_SteppingAction::~GEM_support_SteppingAction()
{
...
bool GEM_support_SteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void GEM_support_SteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "GEM_support_SteppingAction::SetTopNode - unable to find "
