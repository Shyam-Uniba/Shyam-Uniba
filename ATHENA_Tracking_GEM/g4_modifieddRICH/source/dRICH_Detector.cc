...
//____________________________________________________________________________..
dRICH_Detector::dRICH_Detector(PHG4Subsystem *subsys,
...
int dRICH_Detector::IsInDetector(G4VPhysicalVolume *volume) const
{
...
//_______________________________________________________________
void dRICH_Detector::ConstructMe(G4LogicalVolume *logicWorld)
{
	//begin implement your own here://
	...
	// ---------------- // ---------------- // ---------------- // ---------------- // ---------------- // ---------------- // ---------------- //
	// Parameters
	double overall_z_pos = 173 * cm;
	double overall_gas_length = 180 * cm;
	// ----------------
	// Mylar entrance
...
// ======================================================================================================
void dRICH_Detector::Print(const std::string &what) const
{
	cout << "dRICH_ Detector:" << endl;
...
// ======================================================================================================
G4Material *  dRICH_Detector::element_material( std::string identifier ){
...
// ======================================================================================================
void  dRICH_Detector::addDetectorSection( G4LogicalVolume *logicWorld , std::string name , double z_pos , double thick , std::string material , std::string color){
	...
	G4LogicalVolume *logical = new G4LogicalVolume(G4_polycone,G4_mat, "dRICH_Logical");
