...
//____________________________________________________________________________..
dRICH_SteppingAction::dRICH_SteppingAction(dRICH_Detector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
dRICH_SteppingAction::~dRICH_SteppingAction()
{
...
bool dRICH_SteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void dRICH_SteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "dRICH_SteppingAction::SetTopNode - unable to find "
