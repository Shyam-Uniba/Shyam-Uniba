#include "GEM_support_DisplayAction.h"
...
GEM_support_DisplayAction::GEM_support_DisplayAction(const std::string &name)
  : PHG4DisplayAction(name)
  , m_MyVolume(nullptr)
{
}

GEM_support_DisplayAction::~GEM_support_DisplayAction()
{
...
void GEM_support_DisplayAction::ApplyDisplayAction(G4VPhysicalVolume *physvol)
{
