...
MyMainFrame::MyMainFrame(){
   ...
   fCanvas1->MoveResize(8,8,500,300); // startx, starty, width, height
   ...
   fCanvas2->MoveResize(528,8,500,300);
   ...
   fCanvas3->MoveResize(1048,8,500,300);
   ...
   fCanvas4->MoveResize(8,328,500,300);
   ...
   fCanvas5->MoveResize(528,328,500,300);
   ...
   fCanvas6->MoveResize(1048,328,500,300);
   ...
   fCanvas7->MoveResize(8,648,500,300);
   ...
   fCanvas8->MoveResize(528,648,500,300);
   ...
   fCanvas9->MoveResize(1048,648,500,300);
   
   ULong_t bluecolor, redcolor;
   gClient->GetColorByName("blue", bluecolor);
   ...
   fTextButton951->SetTextColor(bluecolor);
   fTextButton951->SetFont(labelfont);
   ...
   fTextButton951->MoveResize(700,960,200,30);
   ...
   fTextButton952->SetTextColor(redcolor);
   fTextButton952->SetFont(labelfont);
   ...
   fTextButton952->MoveResize(920,960,200,30);

   Int_t minX = 1580, widthX = 300;
   Int_t stepY = 10,   widthY = 30, minY =0;

   ULong_t ucolor;        // will reflect user color changes
   gClient->GetColorByName("#F2D2BD",ucolor);
   ...
   fLabel953->SetTextFont(labelfont);
   ...
   fLabel953->MoveResize(minX,stepY,widthX,widthY);
   minY = widthY+2.0*stepY;
   ...
   fLabel954->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fDetectorWidthValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fLabel959->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fDetectorLengthValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fDetectorDepth->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fDetectorDepthValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fNtypeDopingDensity->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fNtypeDopingDensityValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fPtypeDopingDensity->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fPtypeDoingDensityValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fBoundaryCondition->SetTextFont(labelfont);
   ...
   fBoundaryCondition->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fReverseBiasVoltage->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fReverseBiasVoltageValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fTemperature->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fTemperatureValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fBField->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fBFieldValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fBeamCondition->SetTextFont(labelfont);
   ...
   fBeamCondition->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   gClient->GetColorByName("#85c2a3",ucolor);
   ...
   fMIP->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fMIPValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fIncedentAngle->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
   ...
   fIncedentAngleValue->MoveResize(minX,minY,widthX,widthY);
   minY+= widthY+stepY;
...
void MyMainFrame::SolveCurrent(Double_t time,Double_t nmesh , std::vector<TCanvas *> C){
    ...
    hdensity->Draw("box2 ");
    C.at(7)->cd();
    //gPad->SetLogx(1); // commented by Shyam
