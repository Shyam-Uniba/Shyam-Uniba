...
void testDetectorUp1() {
  ...
  its.SetAvgRapidity(0.); // This is pesudorapidity eta
...
// Don't assign Rphi resolution and Z Resolution, it will be assigned very large number
  ...
  //
  //  
  its.AddLayer((char*)"VTX1",  3.6 ,  x_x0VTX, resRPhiVTX, resZVTX,eff); 
  its.AddLayer((char*)"VTX2",  4.8 ,  x_x0VTX, resRPhiVTX, resZVTX,eff); 
  its.AddLayer((char*)"VTX3",  10.5 ,  x_x0VTX, resRPhiVTX, resZVTX,eff); 
  its.AddLayer((char*)"Barr1",  18.0 ,  x_x0VTX, resRPhiVTX, resZVTX,eff);
  its.AddLayer((char*)"InnerCage",  19.5,  radLInnerCage); 
//  its.AddLayer((char*)"VTXSUPPORT",  13.0 ,  x_x0VTX_SUP); 
  if (flag_addTPC){
  ...
  its.AddLayer((char*)"OuterCage",  40.5,  radLOuterCage); 
  its.AddLayer((char*)"BARR2", 42.0+shift, x_x0BARR, resRPhiBARR, resZBARR,eff); 
 // its.AddLayer((char*)"BARRSUPPORT", 42.50+shift,  x_x0BARR_SUP); 
  its.AddLayer((char*)"MPGD1",  60.0 ,  x_x0MM, resRPhiMM, resZMM,eff); 
  its.AddLayer((char*)"MPGD2",  64.0 ,  x_x0TOF, resRPhiTOF, resZTOF,eff); 
 // its.AddLayer((char*)"DIRC",  72.96,  x_x0DIRC);
  its.AddLayer((char*)"MPGD3",  77.0 ,  x_x0MM, resRPhiMM, resZMM,eff);   
