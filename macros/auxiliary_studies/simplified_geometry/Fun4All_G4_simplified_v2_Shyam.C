...
void Fun4All_G4_simplified_v2_Shyam(
...
//http://fismed.ciemat.es/GAMOS/GAMOS_doc/GAMOS.5.1.0/x11519.html
	...
	if(magnetic_field==1){          // uniform 1.5T
		...
		TString path_to_map = "/home/shyam/Singularity/g4lblvtx/macros/auxiliary_studies/simplified_geometry/magfield/EIC_Magnetic_Field_Map_2021_05_07_radial_coords_[cm]_[T].120000.lines.Bmap";
